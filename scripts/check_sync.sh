...
Options:
  ...
  --local-rpc URL          Local RPC URL (default: http://127.0.0.1:${RPC_PORT:-8551})
  --public-rpc URL         Public/reference RPC URL (default: https://public-en.node.kaia.io)
...
Examples:
  ./check_sync.sh --public-rpc https://public-en.node.kaia.io
  ./check_sync.sh --compose-service kaia --public-rpc https://public-en.node.kaia.io
  CONTAINER=kaia-1 PUBLIC_RPC=https://public-en.node.kaia.io ./check_sync.sh
EOF
}
...
LOCAL_RPC="${LOCAL_RPC:-http://127.0.0.1:${RPC_PORT:-8551}}"
PUBLIC_RPC="${PUBLIC_RPC:-https://public-en.node.kaia.io}"
